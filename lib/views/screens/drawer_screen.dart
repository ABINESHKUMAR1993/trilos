...
import 'package:trilo/views/screens/edit_profile_screen.dart';
import 'package:trilo/views/screens/my_language_screen.dart';
import 'package:trilo/views/screens/notification_screen.dart';
import 'package:trilo/views/screens/talk_time_screen.dart';
import 'package:trilo/views/screens/user_settings_screen.dart';
import 'package:trilo/views/screens/transaction_screen.dart';
...
class DrawerScreenState extends State<DrawerScreen> {
  ...
  Future<void> _getProfile() async {
    ...
    print("Fetching profile with auth token: $authToken");
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['status'] == 'success' && data['data'] != null) {
          ...
          print('API response is not successful: ${data['message']}');
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          _buildMenuItem(
            ...
            title: "Buy Talktime",
            onTap: () {
              print("Navigating to TalkTimePage");
              Get.to(() => TalkTimePage());
            },
          ...
          _buildMenuItem(
            ...
            title: "Notification",
            onTap: () {
              print("Navigating to NotificationPage");
          ...
          _buildMenuItem(
            ...
            title: "My Languages",
            onTap: () {
              print("Navigating to LanguageScreen");

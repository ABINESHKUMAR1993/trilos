...
import 'package:trilo/views/screens/otp_screen.dart';
import 'package:trilo/views/widgets/app_button.dart';
import 'package:trilo/views/widgets/textfield_widget.dart';
...
class LoginScreenState extends State<LoginScreen> {
  ...
  void initState() {
    super.initState();
    _loadPreferences(); // Load the preferences when the screen is initialized
  }

  // Load the stored preferences from shared_preferences
  _loadPreferences() async {
    final prefs = await SharedPreferences.getInstance();
    setState(() {
      _selectedCountryCode =
          prefs.getString('countryCode') ??
          '+91'; // Default to +91 if not found
      _isChecked =
          prefs.getBool('termsAccepted') ??
          false; // Default to false if not found
    });
  }

  // Save the preferences to shared_preferences
              ...
              CustomTextField(
                ...
                prefixIcon: CountryCodePicker(
                  onChanged: (code) {
                    ...
                    _savePreferences(); // Save country code selection
                  },
                  ...
                  Theme(
                    ...
                    child: Checkbox(
                      ...
                      onChanged: (value) {
                        ...
                        _savePreferences(); // Save terms acceptance status
                      },
                    ),
                  ),
                  Expanded(
